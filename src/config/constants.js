...
export const SMHIParameter = {
    ...
    DAILY_TEMP_MEAN: '2',     // Air temperature (daily mean)
    DAILY_PRECIP: '5',        // Precipitation (daily)
    HOURLY_PRECIP: '7',       // Precipitation (hourly)
    SNOW_DEPTH: '8',          // Snow depth (daily)
    PRECIPITATION_15MIN: '14', // Precipitation (15-minute)
    DAILY_TEMP_MIN: '19',     // Air temperature (daily minimum)
    DAILY_TEMP_MAX: '20',     // Air temperature (daily maximum)
...
export const CACHE_TTL = {
    current: 300,      // 5 minutes for current/latest data
    ...
    temperature: 300,  // 5 minutes for temperature data
    precipitation: 300, // 5 minutes for precipitation data
